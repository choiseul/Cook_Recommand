...
import kr.kookmin.myprivatechef.RecycleAdapter;
import kr.kookmin.myprivatechef.model.Category;
import kr.kookmin.myprivatechef.model.Feelings;
import kr.kookmin.myprivatechef.model.Recipe;
import kr.kookmin.myprivatechef.Request.JsonArrayRequest;
import kr.kookmin.myprivatechef.util.EndlessRecyclerOnScrollListener;
...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void initData() {
        ...
        Nickname = pref.getString("username", "Test");       // get username
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        if (jsonObject.has("wasLiked"))                                   // Set Like id
                            ...
                            wasLiked = "false";
                        Recipe recipe = new Recipe(jsonObject.getString("title"), jsonObject.getString("id"), imgUrl, wasLiked, jsonObject.getString("temperature"), jsonObject.getInt("cooktime"), jsonObject.getInt("calorie"));
